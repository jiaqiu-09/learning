...
// const sReactive = {foo: 1, bar: {foo: 2}}
// const p1 = shallowReactiveProxy(sReactive)

// effect(() => {
//   console.log(p1.foo)
//   console.log(p1.bar.foo)
// })
...
// const rReactive = {foo: 1, bar: {foo: 2}}
// const p2 = reactiveProxy(rReactive)

// effect(() => {
//   console.log(p2.foo)
//   console.log(p2.bar.foo)
// })
// p2.foo ++
// p2.bar.foo ++

// const p1 = readOnly({foo: 1, bar: {foo: 2}})
// effect(() => {
//   console.log(p1.foo)
//   console.log(p1.bar.foo)
// })
...
const p2 = readOnlyShallow({foo: 1, bar: {foo: 2}})
effect(() => {
  console.log(p2.foo)
  console.log(p2.bar.foo)
})
