...
//   ]
// }
// renderer.render(vnode5, document.getElementById('case1'))
// setTimeout(() => {
//   renderer.render(vnode6, document.getElementById('case1'))
// }, 3000)
...
renderer.render(vnode7, document.getElementById('case'))
setTimeout(() => {
  renderer.render(vnode8, document.getElementById('case'))
}, 3000)
...
renderer.render(vnode9, document.getElementById('case1'))
setTimeout(() => {
  renderer.render(vnode10, document.getElementById('case1'))
}, 3000)
